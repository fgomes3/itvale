            ...
            <div class="container">
                <div class="row">
                    <div class="span5" style="margin-bottom: 20px; margin-top: 20px;">
                        <img style="border: 1px solid #FFFFFF;" width="400" src="img/seguranca.jpg">
                    </div>
                    <div class="span6">
                        <h1 style="color: #FFFFFF;"><i class="icon-lock"></i> Seguran&#231;a</h1>
                        ...
                        <p class="descricaoservico">Otimizando, armazenando e protegendo informa&#231;&#245;es possibilitando o gerenciamento de todos os seus dados com mais efici&#234;ncia.</p>
                    </div>
                </div>
            </div>
        </div>
